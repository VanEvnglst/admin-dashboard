const DatabaseConstants = {
  ...
  createSalesTransTable:
    ...
    'Date Text, CashierName Integer, TotalItemsWithVoid Integer, TotalAmountWithVoid Numeric, DateVoided Numeric, Status Text,' +
  ...
  insertNotifications:
    ...
    `('Birthday discount', 'Avail of our free upsize on your drink if it's your birthday', 'Whole of April')` +
  ...
  insertItemTransactions:
    'INSERT INTO ItemTransactions () VALUES' +
    `()` + 
    `()` + 
    `()` + 
    `()` + 
